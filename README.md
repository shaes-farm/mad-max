# Mad Maxine — 1986 Jeep Comanche MJ Restoration

A long-term mechanical restoration of a 1986 Jeep Comanche MJ ("Mad Maxine") as a farm utility
truck for SHAES Farm. The goal is a reliable, capable daily driver for mountain roads and livestock
care — not a show truck. Cosmetics are irrelevant; mechanical integrity is everything.

**VIN:** 1JTHL6571GT042543 · **Engine:** 2.5L AMC I4 (Renix TBI) · **Trans:** AX5 5-speed ·
**Axles:** Dana 30 / Dana 35 · **Mileage:** ~118,000

**Project start:** January 2026 · **Budget target:** $3,000–$5,000
...
Invoices for all parts orders are in [docs/invoices/](docs/invoices/).

### Reference Materials

Factory service manuals, parts catalogs, and technical references are in
[docs/references/](docs/references/) (stored in Git LFS).

---

## Quick Reference

**AI assistant context:** [Jeep_Comanche_Project_Brief.md](docs/Jeep_Comanche_Project_Brief.md)
contains the full vehicle spec sheet, known issues list, and project context for use in AI-assisted
research and repair sessions.

**Parts sourcing:** RockAuto, NAPA/AutoZone/O'Reilly, ComancheClub.com marketplace. XJ Cherokee
parts (1984–1996) share significant interchange with the MJ Comanche.

**Community:** [ComancheClub.com](https://www.comancheclub.com) — the definitive MJ owner community
and knowledge base.
