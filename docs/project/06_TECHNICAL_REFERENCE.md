...
This is the **single authoritative technical reference** for all specifications.

**For project status and current issues:** See **Jeep_Comanche_Project_Brief.md**  
**For work procedures and tasks:** See **03_MASTER_RESTORATION_PLAN.md**

This document provides: specifications, torque values, fluid types, maintenance schedules, troubleshooting guides, and parts interchange information.
...
- Shackles
- U-bolts
- **Current:** Appears to have matching lift
...
- Lug nut torque: 75-85 lb-ft
- Tire pressure: 26-32 PSI (adjust for load and tire size)
...
4. **IAC valve dirty** — Causes idle problems. Clean regularly with throttle body cleaner.
5. **O2 sensor degradation** — Causes poor fuel economy, rough running. Replace every 50k-100k miles.
...
- Corrosion on any ground causes sensor malfunctions

**Helpful Resource:** The "Renix Bible" — search ComancheClub.com or Jeep forums for comprehensive diagnostic guide.

---

## COMMON 2.5L AMC I4 ISSUES
...
- Known for longevity when oil is changed regularly

---

## AX5 TRANSMISSION NOTES

### Characteristics

- 5-speed manual, Aisin-Warner design
- Light-duty transmission; adequate for 2.5L but not ideal for heavy loads or aggressive use
- Known as a "weak" transmission but adequate for normal use
- Direct upgrade path to AX15 (stronger) if failure occurs
...
- Change every 30,000 miles or when servicing

**Alternative:** 75W-90 gear oil in warm climates, but ATF is preferred
...
4. **Input shaft bearing** — Can fail with high mileage.

### Maintenance Tips

- **Fresh fluid often dramatically improves shift quality**
- Avoid aggressive/fast shifts (be gentle with synchros)
- Double-clutch into reverse if grinding
- If reverse is sticky: try shifting into 1st gear first, then reverse (helps synchro engagement)
- Change fluid every 30k miles or if quality/ease of shifting degrades
...
- Cost: $500-800 used
- Gear ratios slightly different but very close
- Recommended if AX5 fails beyond repair

---

## NP207 TRANSFER CASE NOTES

### Characteristics (Your Vehicle)

- Command-Trac part-time 4WD system
- Aluminum case with chain drive
- **Shift Pattern:** 2WD → 4WD-Part Time (4H) → Neutral → 4WD-Low (4L)
- Moderate duty; adequate for this application
...
- When servicing leaks, inspect chain for stretch (>1/2" play indicates replacement needed)
- Use only Dexron III ATF (do not use gear oil)
- Clean magnetic drain plug to check for metal contamination
...
**API Rating:** SG or higher (SJ, SL, SM, SN all acceptable)  
...
**Color:** Green (conventional) or Orange (Dex-Cool compatible)  
**Capacity:** 9 quarts (total system)  
...
### Transfer Case Fluid (NP207)

**Type:** Dexron III ATF  
**Capacity:** 4.5 pints (2.25 quarts)  
**Change Interval:** 30,000 miles or 2 years

**Use same ATF as transmission**

### Differential Fluid

**Type:** 80W-90 GL-5 gear oil  
**Capacity:** Front (Dana 30): 2.5 pints | Rear (Dana 35): 3.5 pints  
**Change Interval:** 30,000 miles or 2 years
...
**Note:** Synthetic gear oil provides better protection and cold-weather performance.

### Brake Fluid

**Type:** DOT 3 or DOT 4  
**Change Interval:** 2 years (regardless of mileage)
...
**Type:** Dexron III ATF or power steering fluid  
**Capacity:** As needed (reservoir-based system)  
**Check:** Monthly

### Grease

**Type:** Lithium-based multi-purpose grease  
...
- Gauge clusters ✅
- Switches and electrical components ✅
- Seats ✅
- Seat belts ✅
- Headliner (2-door XJ) ✅
- Carpet (partial - front section) ✅
- Dash components ✅
- Steering column ✅
- Mirrors ✅
...
- Front axle (Dana 30) ✅
- Rear axle (Dana 35, Dana 44) ✅
- Driveshafts (front - verify length) ✅
- Suspension components (mostly interchangeable) ✅
- Steering components (mostly interchangeable) ✅
...
- Light assemblies (headlights, tail lights) ✅
- ECM/PCM (year-specific) ⚠️
...
### Break-In Period (First 500 miles after major work)

- [ ] Check all fluid levels daily
- [ ] Inspect for leaks after every drive
- [ ] Retorque lug nuts at 50 miles, 100 miles, 500 miles
- [ ] Retorque head bolts if cylinder head was removed
...
- Grease chassis (if equipped with fittings)
...
- Complete brake inspection (remove wheels)
- Complete steering/suspension inspection
- Test all electrical systems
- Flush and refill coolant (every 2 years)
...
- Replace fuel filter
- Replace air filter (if not done sooner)
- Inspect U-joints, replace if worn
...
- Inspect frame and body for rust
- Complete suspension rebuild if needed
...
4. Count how many times driveshaft rotates
5. Divide driveshaft rotations by 2
6. Result = gear ratio

Example: If driveshaft rotates 7 times for 2 wheel rotations:
7 ÷ 2 = 3.50 gear ratio
...
- 4.10:1 (rare, off-road/towing)

**Front and rear MUST match** for 4WD operation.
...
4. Check neutral safety switch (clutch pedal switch)
5. Verify ignition switch is working
...
4. TPS out of adjustment

**Test CTS:** Should read ~3,000 ohms cold, ~300 ohms hot
...
**Diagnosis:** Clean engine, add UV dye, run briefly, inspect with UV light
...
6. Head gasket failure (check for mixing)

**Quick Test:** Feel upper and lower radiator hoses when warm. Both should be hot. If lower is cold, thermostat may be stuck.
...
4. Transfer case internal issue

**Quick Test:** Shift to 4WD, check if front driveshaft is spinning when wheels turned.
...
4. Worn brake pads/shoes

**Quick Test:** Pump brake pedal several times. If it gets firmer, air is in system. If stays soft, master cylinder may be weak.
...
You're going 6.4 mph faster than indicated.
...
### Gear Ratio vs. Engine RPM

```
RPM = (MPH × Gear Ratio × Tire Revs per Mile) / (Transmission Gear × 60)
```
...
2. **Factory Service Manual (FSM)**
   ...
   - Search: "1986 Jeep Comanche FSM PDF"

3. **Online Resources:**
   - ComancheClub.com forums (primary MJ resource)
   - JeepForum.com (MJ section)
   - NAXJA.org (XJ forum, many parts identical)
   - YouTube channels specific to MJ Comanche
...
**Version:** 2.0 (Enhanced with Parts Interchange)  
**Last Updated:** January 2026  
**Next Review:** Update as specifications are verified during restoration